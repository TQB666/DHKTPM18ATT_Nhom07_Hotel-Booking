...
const BookingHistory = () => {
    ...
    // Render nội dung chính dựa trên trạng thái (Loading/Error/Data)
    const renderContent = () => {
        if (loading) {
            return (
    ...
    return (
        // Wrapper ngoài cùng sử dụng flex-col và min-h-screen để Footer luôn nằm dưới đáy
        <div className="flex flex-col min-h-screen bg-gray-50">
            {/* Header nằm ngoài container nên sẽ full width */}
            <Header />

            {/* Phần nội dung chính nằm trong container để căn giữa */}
            ...
            {/* Footer nằm ngoài container nên sẽ full width */}
            <Footer />
        </div>
    );
};
